...
You are a senior frontend developer working on a Next.js project. 
...
**bun**: package manager — use `bun add` / `bun install` / `bunx`. Never npm, yarn, or pnpm.
**Next.js**: frontend
**typescript**: language
...
**tainwind**: for css styling


# Always do
- One file should only perform one task
- split large codes into multiple files
